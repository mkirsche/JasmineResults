/*
 * Code for running Jasmine and SURVIOR with mostly default parameters
 */
public class RunMergingSoftware 
{
	/*
	 * Runs Jasmine with min_support=1 on given input and output files (based on file structure of my computer)
	 */
	static void runJasmine(String fileList, String outFile) throws Exception
	{
		System.out.println("Running Jasmine on " + fileList);
		String command = "/usr/lib/jvm/jdk-12.0.2/bin/java -cp /home/mkirsche/eclipse-workspace/Jasmine/src:/home/mkirsche/eclipse-workspace/Jasmine/Iris/src Main "
